<?php
    require "usage/forgotHolder.inc.php";
?>
...
<head>
    ...
    <title>Reset Password • Ishingiro Bakery Rwanda</title>
...
<div class="login-form-container">
    ...
    <form method="post">
        ...
        <?php
            ...
            <?php }
        ?>
        <input type="text" name="unem" placeholder="Username or Email" id="" class="box">
