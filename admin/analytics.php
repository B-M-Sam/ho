...
<head>
	...
	<title>Analytics | Ishingiro Bakery</title>
</head>
<body>
	...
	<section id="content">
		...
		<nav>
			...
			<form action="#" display="none">
				<div class="form-input" display="none">
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" style="font-family: 'Satisfy', cursive;" href="#">Analyze how the work is..</a>
						</li>
					</ul>
				</div>
